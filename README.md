...
* [NiftyWindows](https://github.com/ahkscript/awesome-AutoHotkey/issues/180) - control of all basic window interactions such as dragging, resizing, maximizing, minimizing, closing, snap-to-grid, "keep window aspect ratio", rolling up a window to its title bar, transparency control.
